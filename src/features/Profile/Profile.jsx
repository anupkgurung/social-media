...
import { usePost, getUserPosts,useAuth } from "../../features"
                ...
                <div className="md:mt-0 mx-auto mb-4">
                    <div className="my-4 w-full md:mt-0 mx-auto border-b-[1px] border-t-[1px] bg-white flex flex-col relative">
                        ...
                        <div className="flex p-2 pt-4">
                            ...
                            <button className="border ml-auto py-2 px-4 text-sm border-blue-400 rounded hover:bg-blue-400"> Edit Profile</button>
                        </div>
                        <div className="mx-3 flex flex-col p-2 px-2 pt-5">
                            <div className="mr-auto"><span className="font-bold text-2xl">Anup</span></div>
                            <div className="mt-[-.25rem] mr-auto"><span className="text-lg text-gray-400">@anupkmr</span></div>
                        </div>
                        <div className="flex mx-3 flex-col p-2 px-2 pt-2">
                            <div className="mr-auto"><p className="text-base">BIO</p></div>
                            <div className="mr-auto"><Link className="underline text-blue-400" to="https://github.com/anupkgurung">https://github.com/anupkgurung</Link></div>
                        </div>
